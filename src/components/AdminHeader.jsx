...
export default function AdminHeader({ isSidebarOpen, setIsSidebarOpen }) {
  ...
  const pageMeta = {
    "/admin": { title: "Beranda", desc: "Selamat Datang di Panel Admin" },
    "/admin/murid": { title: "Kelola Murid", desc: "Management Data Siswa & Siswi" },
    "/admin/guru": { title: "Kelola Guru", desc: "Management Data Tenaga Pengajar" },
    "/admin/mapel": { title: "Kelola Mapel", desc: "Management Mata Pelajaran" },
    "/admin/kelas": { title: "Kelola Kelas", desc: "Management Ruang & Wali Kelas" },
    "/admin/jadwal": { title: "Kelola Jadwal", desc: "Management Jadwal Pelajaran & Ujian" },
    "/admin/akun": { title: "Kelola Akun", desc: "Management Hak Akses & Pengguna" },
  };
