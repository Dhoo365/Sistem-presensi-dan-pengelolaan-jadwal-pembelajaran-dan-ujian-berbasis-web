...
// STYLE MATCH ADMIN SIDEBAR
// KEEP ALL OLD FUNCTION
// MOBILE DRAWER READY
// DESKTOP HIDE READY
// SAME THEME ADMIN
// PRODUCTION READY
...
export default function SidebarGuru({
  ...
  return (
    <>
      ...
      {/* DESKTOP SAME ADMIN STYLE */}
      <aside
        className={`hidden lg:flex h-screen bg-[#3B3128] text-white flex-col shadow-2xl transition-all duration-300 relative ${
          isSidebarOpen
            ? "w-[280px]"
            : "w-0 overflow-hidden"
        }`}
